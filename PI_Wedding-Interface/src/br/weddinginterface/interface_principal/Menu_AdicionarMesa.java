 ...
 * @author Tips
 */
public class Menu_AdicionarMesa extends javax.swing.JFrame {

    /**
     * Creates new form Menu_Noiva
     */
    public Menu_AdicionarMesa() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(820, 590, 110, 27);

        jLabel7.setFont(new java.awt.Font("Century Gothic", 1, 16)); // NOI18N
        jLabel7.setText("N° DE MESAS");
        background.add(jLabel7);
        jLabel7.setBounds(770, 350, 100, 21);

        jTextField4.setToolTipText("Informe o número de mesas a serem criadas.");
        ...
        jTextField4.setBounds(770, 370, 220, 20);

        jTextField5.setToolTipText("Informe o número de cadeiras por mesa.");
        ...
        jTextField5.setBounds(770, 510, 220, 26);

        jLabel18.setFont(new java.awt.Font("Century Gothic", 1, 16)); // NOI18N
        jLabel18.setText("N° DE CADEIRAS");
        background.add(jLabel18);
        jLabel18.setBounds(770, 490, 220, 21);

        jLabel19.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/toalha-de-mesa.png"))); // NOI18N
        background.add(jLabel19);
        jLabel19.setBounds(730, 350, 30, 40);

        jLabel21.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/cadeira-de-madeira.png"))); // NOI18N
        background.add(jLabel21);
        jLabel21.setBounds(730, 490, 40, 40);
 ...
 new Menu_Noiva().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Menu_AdicionarMesa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
